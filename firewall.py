        ...
        with open(WEB_HTML, "w") as f:
            ...
            for line in activity:
                ...
                if not args.print and "🚨 Blocked IP:" in line:
                    IP = line.split(":")
                    value = line.split(" ")
                    line = f"🚨 Blocked IP: <a style=\"text-decoration:none\" target=\"_blank\" href=\"https://{value[3]}\">{value[3]}</a>  {value[5-6]}"
                if not args.print and "🚨 Blocked Subnet:" in line:
                    IP = line.split(":")
                    value = line.split(" ")
                    line = f"🚨 Blocked Subnet: <a style=\"text-decoration:none\" target=\"_blank\" href=\"https://{value[3]}\">{value[3]}</a>  {value[5-6]}"
