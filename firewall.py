        ...
        with open(WEB_HTML, "w") as f:
            ...
            for line in activity:
                ...
                if not args.print and "🚨" in line:
                    ...
                    URL_FIX = line.split(" ")
                    line = f"<a style=\"text-decoration:none\" target=\"_blank\" href=\"https://{URL_FIX[0]}\">🚨 {URL_FIX[1]}</a> {URL_PARSE[2]} <a href=\"https://www.ip-tracker.org/lookup.php?ip={URL_PARSE[1]}\" style=\"text-decoration:none\" target=\"_blank\">  🔍 <a style=\"text-decoration:none\" href=\"https://who.is/whois-ip/ip-address/{URL_PARSE[1]}\" target=\"_blank\">🌐</a>"
