...
def main():
    ...
    while True:
        ...
        with open(WEB_HTML, "w") as f:
            ...
            f.write(" <style> body { font-family: Arial; color: white; } .split { height: 90%; width: 10%; position: fixed; z-index: 1; top: 100; overflow-x: hidden; padding-top: 20px; } .left { left: 0; } .right { right: 0; } .centered { position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); text-align: center; } .centered img { width: 150px; border-radius: 50%; }")
            f.write("</style></head>")
            f.write(
